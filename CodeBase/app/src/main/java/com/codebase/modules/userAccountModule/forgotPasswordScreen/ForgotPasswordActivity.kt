...
class ForgotPasswordActivity : BaseActivity(), AccountView {

    @Inject lateinit var mPresenter: ForgotPasswordPresenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mProgressHandler.setContext(this@ForgotPasswordActivity)
